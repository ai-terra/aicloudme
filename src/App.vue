...
github.com/ai-teams`,
      ...
      matrixDev: [
        ['a','SOCIAL',':','project','','priority','=','1','','votes','=','247','','likes','=','1234','','comments','=','144','','clones','=','24','','',''],
        ['1','Click',':','= if ( opsStatus == "ready" ) { state = "Ok" } else { state = "Quit" }','','','','','','','','','','','','','','','','','','','','','','',''],
        ['b','RATES',':','money','','','','','','','','','','','','','','','','','','','','','','',''],
        ['1','type',':','script','','','','','','','','','','','','','','','','','','','','','','',''],
        ['c','DOCS',':','terms','','','','','','','','','','','','','','','','','','','','','','',''],
      ...
      matrixOps: [
        ['a','MARKET',':','ready','','','','','','','','','','','','','','','','','','','','','','',''],
        ['1','Click',':','= if ( devStatus == "project" ) { state = "Ok" } else { state = "Quit" }','','','','','','','','','','','','','','','','','','','','','','',''],
        ['b','RATES',':','money','','','','','','','','','','','','','','','','','','','','','','',''],
        ['1','','','','','','','','','','','','','','','','','','','','','','','','','',''],
        ['c','DOCS',':','terms','','','','','','','','','','','','','','','','','','','','','','',''],

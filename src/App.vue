          ...
          <div id="ai-protocol">
            ...
            <div id="ai-prog">
              <div class="buttons">
                ...
                <button contenteditable="true" class="next btn btn-primary" title="Next Option" @click="nextBranch">Options</button>
                <button contenteditable="true" class="next btn btn-primary" @click="addNewRule">Rule:</button>
